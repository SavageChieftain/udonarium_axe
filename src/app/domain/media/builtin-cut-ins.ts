...
/** The window snapping open sideways, which is what reads as a flash rather than a fade. */
const SNAP_OPEN: CutInTrackSet = {
  scaleX: [
...
export const DEFAULT_CUT_IN_SEEDS: readonly CutInSeed[] = [
  {
    ...
    layers: [
      {
        identifier: 'sample-cut-in-flash-dim',
        name: '暗幕',
        kind: 'fill',
        x: 0,
        y: 0,
