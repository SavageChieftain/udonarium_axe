...
export const PF_APPSPOT_SYSTEMS: Record<string, PsychoFictionConfig> = {
  ...
  starrydolls: {
    dicebot: 'StarryDolls',
    categories: ['願望', '元素', '星使い', '動作', '召喚', '人間性'],
    skillsByCategory: [
      ['創造', '研究', '守護', '絆', '*かに座', '夢', '*しし座', '自由', '恋愛', '脚光', '世界'],
      ['光', '雷', '*ふたご座', '水', '火', '風', '木', '氷', '*おとめ座', '土', '闇'],
      [
        '*おうし座',
        '幸運',
        '幻影',
      ...
      ['*おひつじ座', '精密', '高速', '怪力', '隠密', '飛行', '言霊', '模倣', '軽業', '歌舞', '*さそり座'],
      ['リボン', '照明具', '*うお座', '料理', '獣', '花', '乗り物', '書物', '*いて座', '武器', '財宝'],
      ['勇気', '知恵', '熱意', '調和', '*みずがめ座', '愛情', '*やぎ座', 'センス', '根気', '礼節', '理性'],
    ],
    abilityKey: 'spells',
    abilitySectionLabel: '呪文',
    targetSkillKey: 'skill',
    abilityFields: [
      { key: 'timing', label: 'タイミング' },
      { key: 'skill', label: '指定特技' },
  ...
  kancolle: {
    ...
    skillsByCategory: [
      ...
      ['素直', 'クール', '優しい', 'おしとやか', 'けなげ', '笑顔', 'ばか', 'さわやか', '面白い', 'えっち', '派手'],
      [
        '不思議',
        'おおらか',
        '面倒見',
      ...
      ['寝る', '空想', '生き物', '読書', '食べ物', 'おしゃべり', '買い物', '芸能', 'おしゃれ', '入浴', '恋愛'],
      ['暗号', '通信', '索敵', '規律', '補給', '待機', '機動', '海図', '指揮', '衛生', '整備'],
      ['電子戦', '航空打撃戦', '航空戦', '対空戦闘', '突撃', '砲撃', '退却', '支援', '魚雷', '対潜戦闘', '夜戦'],
    ],
    abilityKey: 'ability',
    abilitySectionLabel: '能力',
    abilityFields: [
      { key: 'type', label: '種別' },
      { key: 'category', label: '分類' },
      { key: 'targetSkill', label: '指定特技' },
      { key: 'range', label: 'タイミング' },
      { key: 'effect', label: '効果' },
    ],
    profileFields: [
      { key: 'nameKana', label: '艦種' },
      { key: 'level', label: 'レベル' },
      { key: 'actionpoint', label: '行動値' },
      { key: 'exp', label: '経験点' },
      { key: 'player', label: 'PL' },
    ],
    extraSections: [
