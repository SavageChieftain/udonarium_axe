...
export class AppInitializationService {
  ...
  private initializeAudioPresets(): void {
    ...
    const soundMap: Record<SoundKey, string> = {
      ...
      mechDamageSmall: './assets/sounds/soundeffect-lab/mech-damage-small.mp3',
      mechDamageMedium: './assets/sounds/soundeffect-lab/mech-damage-medium.mp3',
      mechDamageLarge: './assets/sounds/soundeffect-lab/mech-damage-large.mp3',
