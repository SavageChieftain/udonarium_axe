...
describe('parseTrumpCardCode', () => {
  it('数字札は suit / rank / suitColor に分解されること', () => {
  ...
  it('絵札は Jack/Queen/King の英単語にすること', () => {
...
describe('formatTrumpCardCode', () => {
  it('parseTrumpCardCode の結果を suit + rank の連結で返すこと', () => {
