...
- **明かり** — 暗闇を有効にするプリセットでは、1 マスの光る地形を最大 5 基置く。狭い部屋には壁掛け松明かランタン（壁に接する床に置き、壁掛けは石から離れる向きへ 200 度の光を投げる）、広い部屋には焚き火・火鉢・ランプスタンド（周りに立てる空きのある床へ）。壁ブロックそのものを光らせると、その地形が光を遮らなくなって最大 12 マス四方の穴が開くため、明かりは必ず 1 マスの独立した地形にする
